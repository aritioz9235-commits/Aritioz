...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    // This composite may contain more than form controls, so fieldset is not equivalent.
    <div
...
function InputGroupAddon({
  ...
  return (
    // The addon can contain nested buttons; making the whole addon a button is invalid HTML.
